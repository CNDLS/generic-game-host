...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.score_accrues_to_computer'
        db.add_column(u'main_game', 'score_accrues_to_computer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.score_accrues_to_computer'
        db.delete_column(u'main_game', 'score_accrues_to_computer')
