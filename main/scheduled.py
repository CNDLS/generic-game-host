...
# 
# NOTE: pulled all exception handling. the layer built into runcrons is actually better, because it preserves the error info in the db.
	...
	for report in report_list:
		...
		if report.payload != None:
			...
			while len(payload):
				...
				try:
					the_round = Round.objects.get(case=report.case, nbr=round_nbr)
				except:
					the_round = None
