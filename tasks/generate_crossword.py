...
# -- word_list eg; ['pumpernickel', 'Dark, sour bread made from coarse ground rye.'], ...
# a.compute_crossword(2) -- nbr of seconds to think on it. if fail, maybe recycle w more secs?
# print a.display() -- space-delimited string for each row. parse in a custom template?
# print a.legend() -- all the clues, plus locations on the board.
# print a.solution() -- for evaluation?
# print a.word_find() -- for a word search variation.
#############
