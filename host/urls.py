...
urlpatterns = patterns('',
    ...
    url(r'^publicsitechanges$', 'main.views.publicsitechanges', name='publicsitechanges'),
    ...
    url(r'^summarize/(?P<game_id>\d+)/$', 'browser.views.summarize', name='summarize'),url(r'^summarize/(?P<game_id>\d+)/$', 'browser.views.summarize', name='summarize'),
